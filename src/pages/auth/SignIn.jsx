  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Sign in to your Buildrix account</p>
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          ...
          <div>
            ...
            <input name="password" type="password" value={form.password} onChange={handleChange} required className={inputCls} placeholder="••••••••" />
          </div>
